        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr] lg:gap-8">
          ...
          <div className="flex flex-col items-start text-left">
            <motion.span
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border bg-muted/50 px-3 py-1.5 text-xs font-semibold text-muted-foreground"
            >
              <Sparkles className="h-3.5 w-3.5 text-primary" />
              The home of software engineering knowledge
            </motion.span>
            ...
            >
              Documentation, tutorials, references, commands, roadmaps, interview
              preparation, and best practices across modern software engineering.
            </motion.p>
            ...
            >
              <Button className="h-12 gap-2 bg-gradient-to-r from-primary to-accent px-6 text-white shadow-glow hover:opacity-90">
                Start Learning
          ...
          >
            ...
            >
              ...
              <span className="mt-2 text-xs font-bold uppercase tracking-wide text-white/90">
                Stack
              </span>
            </motion.div>
